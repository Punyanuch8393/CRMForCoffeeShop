...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>รายงานยอดขายแบ่งตามสมาชิก</h1>
        </div>
        <div class="col-sm-6">
...
/*   <?php include "config.inc.php"; // ไฟล์ติดต่อฐานข้อมูล 
            $sql = "SELECT * FROM inform GROUP BY member ORDER BY inform.member ASC"; 			
			$query = $conn->query($sql); 
			while($result = $query->fetch_assoc()){

                switch ($result['member']) {
                    case "member": $members = "";  break;
                    case "non_member": $members = "";  break;
 ...
 */
	...
	"<?php echo $members;?> <?php echo $result['member'];?>", 
    ...
    datasets: [{
      label: "จำนวนแก้ว",
      backgroundColor: "#7B68EE", //สีกราฟแท่ง
      ...
      data: [
        ...
        /*  <?php include "config.inc.php"; // ไฟล์ติดต่อฐานข้อมูล 
            ...
            $sql_sum = "SELECT Count(inform.orderid) As cc FROM inform where member='$members' "; 			
